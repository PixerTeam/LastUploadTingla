...
class SavedNotScreen extends StatelessWidget {
  const SavedNotScreen({Key? key}) : super(key: key);
    ...
    return Column(
      ...
      children: [
        SizedBox(
          ...
          child: SvgPicture.asset("assets/icons/saved_image.svg"),
        ...
        Text(
          "Saqlangan kitoblar yo’q.\nAmmo kitoblarni saqlashingiz mumkin",
